...
public class CategoriesController : ControllerBase {
  ...
  public async Task<ActionResult<ApiResponse<List<cCategory_DTO>>>> GetCategories() {
    ...
    try {
      ...
      return StatusCode(500, ApiResponse<List<cCategory_DTO>>.Error("Błąd podczas pobierania kategorii", new List<string> { ex.Message }));
    }
  ...
  public async Task<ActionResult<ApiResponse<cCategory_DTO>>> GetCategory(int xCategoryId) {
    ...
    try {
      ...
      if (category == null)
        return NotFound(ApiResponse<cCategory_DTO>.Error("Kategoria nie została znaleziona"));

      return Ok(ApiResponse<cCategory_DTO>.SuccessResult(MappingService.ToDto(category)));
    } catch (Exception ex) {
      return StatusCode(500, ApiResponse<cCategory_DTO>.Error("Błąd podczas pobierania kategorii", new List<string> { ex.Message }));
    }
  ...
  public async Task<ActionResult<ApiResponse<List<cSubcategory_DTO>>>> GetSubcategories(int xCategoryId) {
    ...
    try {
      ...
      return StatusCode(500, ApiResponse<List<cSubcategory_DTO>>.Error("Błąd podczas pobierania podkategorii", new List<string> { ex.Message }));
    }
  ...
  public async Task<ActionResult<ApiResponse<cCategory_DTO>>> CreateCategory([FromBody] cCategory_DTO dto) {
    try {
      ...
      return StatusCode(500, ApiResponse<cCategory_DTO>.Error("Błąd podczas tworzenia kategorii", new List<string> { ex.Message }));
    }
  }
  ...
  public async Task<ActionResult<ApiResponse<cCategory_DTO>>> UpdateCategory(int id, [FromBody] cCategory_DTO dto) {
    try {
      ...
      return StatusCode(500, ApiResponse<cCategory_DTO>.Error("Błąd podczas aktualizacji kategorii", new List<string> { ex.Message }));
    }
  }
  ...
  public async Task<ActionResult<ApiResponse>> DeleteCategory(int id) {
    try {
      ...
      await mDBContext.SaveChangesAsync();
      return Ok(ApiResponse.SuccessResult("Kategoria usunięta"));
    } catch (Exception ex) {
      return StatusCode(500, ApiResponse.Error("Błąd podczas usuwania kategorii", new List<string> { ex.Message }));
    }
  }
  ...
  public async Task<ActionResult<ApiResponse<cSubcategory_DTO>>> CreateSubcategory(int categoryId, [FromBody] cSubcategory_DTO dto) {
    try {
      ...
      return StatusCode(500, ApiResponse<cSubcategory_DTO>.Error("Błąd podczas tworzenia podkategorii", new List<string> { ex.Message }));
    }
  }
  ...
  public async Task<ActionResult<ApiResponse<cSubcategory_DTO>>> UpdateSubcategory(int id, [FromBody] cSubcategory_DTO dto) {
    try {
      ...
      return StatusCode(500, ApiResponse<cSubcategory_DTO>.Error("Błąd podczas aktualizacji podkategorii", new List<string> { ex.Message }));
    }
  }
  ...
  public async Task<ActionResult<ApiResponse>> DeleteSubcategory(int id) {
    try {
      ...
      await mDBContext.SaveChangesAsync();
      return Ok(ApiResponse.SuccessResult("Podkategoria usunięta"));
    } catch (Exception ex) {
      return StatusCode(500, ApiResponse.Error("Błąd podczas usuwania podkategorii", new List<string> { ex.Message }));
    }
  }
}
